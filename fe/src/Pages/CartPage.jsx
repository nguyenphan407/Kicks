...
import { motion, AnimatePresence } from "framer-motion"; // Import từ framer-motion
...
const CartPage = () => {
    ...
    // Tính tổng số lượng và tổng giá trị trực tiếp từ cartData
    const cartCount = getCartCount();
    const cartAmount = getCartAmount();

    // Debug: Kiểm tra cartData
            ...
            <div className="container my-6">
                <div className="min-w[782px] flex flex-col gap-2 mb-6 lg:mb-8">
                    ...
                    <p className="text-xs lg:text-[14px] font-semibold opacity-80 text-[#232321]">
                        ...
                        of Year sale - while supplies last. No code needed.
                    </p>
                                            ...
                                            >
                                                ...
                                                <div className="flex flex-col justify-between flex-1">
                                                    ...
                                                    <div className="flex gap-4 lg:gap-6">
                                                        <button className="">
                                                            {/* SVG Icon for some action (e.g., favorite) */}
                                                            <svg
                        ...
                        <div className="flex flex-col gap-4">
                            ...
                            <div className="flex justify-between items-center">
                                ...
                                <p className="font-rubik text-xl lg:text-[24px] font-semibold text-[#4a4a47]">
                                    {currency}
                                    {(cartAmount + Number(delivery_fee)).toFixed(2)}
                                </p>
                            </div>
                        </div>
                        <button
