    ...
    <div className="h-auto container flex flex-col lg:flex-row gap-6 lg:gap-[47px] justify-between mx-auto mt-6 mb-10">
      ...
      <div className="Login flex flex-col lg:pr-[40px] w-full lg:w-[564px] mb-2 gap-6">
        ...
        <div className="w-full h-12 flex items-center gap-2">
          ...
          <label htmlFor="keepLoggedIn" className="flex-1 text-[#232321] text-[14px] lg:text-[16px] font-semibold font-opensans">
      ...
      <div className="Join flex-1 p-6 bg-[#FAFAFA] rounded-2xl flex flex-col gap-[64px]">
        <div className="w-full h-auto flex flex-col gap-6">
          <h2 className="w-full lg:w-[600px] text-[#232321] text-[24px] lg:text-[36px] font-semibold font-rubik">Join Kicks Club Get Rewarded Today.</h2>
