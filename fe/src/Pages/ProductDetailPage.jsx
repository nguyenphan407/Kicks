      ...
      <div className="container">
         <div className="flex flex-col lg:flex-row mt-6 lg:mt-8 gap-4 mb-[24px] lg:mb-[60px]">
            ...
            <div className=" object-cover grid grid-cols-4 lg:grid-cols-2 gap-2 xl:gap-4">
                  <img
                  className="rounded-lg lg:rounded-none w-[400px] h-full 2xl:w-[430px] lg:h-[430px] lg:rounded-tl-[48px] cursor-pointer object-cover
                  ...
                  />
               <img
                  className="rounded-lg lg:rounded-none lg:w-[400px] 2xl:w-[430px] lg:h-[430px] h-full lg:rounded-tr-[48px] cursor-pointer object-cover
                    transform transition duration-300 ease-in-out hover:-translate-y-1 hover:shadow-2xl hover:opacity-90"
               ...
               />
               <img
                  className="rounded-lg lg:rounded-none lg:w-[400px] 2xl:w-[430px] lg:h-[430px] h-full lg:rounded-bl-[48px] cursor-pointer object-cover
                    transform transition duration-300 ease-in-out hover:-translate-y-1 hover:shadow-2xl hover:opacity-90"
               ...
               />
               <img
                  className="rounded-lg lg:rounded-none lg:w-[400px] 2xl:w-[430px] lg:h-[430px] h-full lg:rounded-br-[48px] cursor-pointer object-cover
                    transform transition duration-300 ease-in-out hover:-translate-y-1 hover:shadow-2xl hover:opacity-90"
