...
const Register = () => {
  return (
    <div className="h-auto container flex flex-col justify-end items-start lg:flex-row gap-6 justify-between mt-6 mb-10">
      ...
      <div className="flex flex-col lg:px-[40px] w-full lg:w-[564px] gap-6">
        ...
        <div className="flex flex-col gap-5">
          ...
          <div className="flex gap-8 justify-start items-start flex">
